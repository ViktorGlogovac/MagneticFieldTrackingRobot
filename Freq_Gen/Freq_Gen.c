...
#define Button_up (1<<26)
#define Button_left (1<<25)
#define Button_right (1<<24)
...
void main (void)
{
    ...
    ANSELB &= ~(Button_up | Button_down | Button_left | Button_right); // Set button pins as digital I/O
    TRISB |= (Button_up | Button_down | Button_left | Button_right);   // Configure button pins as inputs
    CNPUB |= (Button_up | Button_down | Button_left | Button_right);   // Enable pull-up resistors for button pins
	SetupTimer1();
